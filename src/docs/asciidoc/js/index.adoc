...
`RegisterController`, which is buildt to structure this
process.
...
defining, that `link:../../jsdoc/mongo_auth-MongoAuth.html[MongoAuth]` shall be used. Currently this is the only implemented
