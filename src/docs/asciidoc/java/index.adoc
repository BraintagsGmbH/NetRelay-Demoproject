...
`link:../../apidocs/de/braintags/netrelay/controller/authentication/RegisterController.html[RegisterController]`, which is built to structure this
...
implements the interface `link:../../apidocs/de/braintags/vertx/auth/datastore/IAuthenticatable.html[IAuthenticatable]` . Additionally the class, which
...
`link:../../apidocs/de/braintags/netrelay/controller/IController.html[IController]` or by extending
`link:../../apidocs/de/braintags/netrelay/controller/AbstractController.html[AbstractController]`, for instance. +
